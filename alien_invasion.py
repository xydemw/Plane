...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # 初始化飞船
        self.ship = Ship(self)  # 添加这行代码来初始化飞船
        ...
        # 新增一个初始的舰队下降速度
        self.settings.fleet_drop_speed = 10  # 这里设置一个初始值，你可以根据需要调整
        self.settings.fleet_drop_speed_increment = 1  # 每次下降速度的增量
